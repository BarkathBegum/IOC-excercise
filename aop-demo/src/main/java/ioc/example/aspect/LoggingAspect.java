...
public class LoggingAspect {
    ...
    @AfterThrowing("execution(* ioc.example.services.CustomerServiceImpl.fetchCustomer(..))")
    ...
    @AfterThrowing(pointcut = "execution(* ioc.example.services.CustomerServiceImpl.fetchCustomer(..))", throwing = "exception")
    public void logAfterThrowingAdviceDetails(JoinPoint joinPoint, Exception exception) {
        logger.info("In After throwing Advice, Joinpoint signature :{}", joinPoint.getSignature());
        logger.error(exception.getMessage(),exception);
    }
    @After("execution(* ioc.example.services.CustomerServiceImpl.fetchCustomer(..))")
    ...
    @Before("execution(* ioc.example.services.CustomerServiceImpl.fetchCustomer(..))")
    ...
    @AfterReturning(pointcut = "execution(* ioc.example.services.CustomerServiceImpl.fetchCustomer(..))")
    ...
    @AfterReturning(pointcut = "execution(* ioc.example.services.CustomerServiceImpl.fetchCustomer(..))", returning = "result")
    ...
    @Around("execution(* ioc.example.services.CustomerServiceImpl.fetchCustomer(..))")
